...
const SectionLeft = ()=> {
    ...
    let frindes = localStorage.getItem("frindes")
                        ...
                        <div className="d-flex  align-items-center" style={{cursor:"pointer"}}>
                            <div className="img-profile">
                                ...
                                <StyledBadge
                                    ...
                                    variant="dot"
                                >
                                    <Avatar style={{width:60,height:60}} alt="Remy Sharp" src='' />
                            ...
                            <div className="name-profile ms-4">
                                ...
                                <p className="mb-0 text-black-50"><span className="fw-bold text-black" >{frindes}</span> Frindes</p>
                            </div>
                        </div>
                    </Link>
                </div>
