        ...
        <div className="d-flex align-items-center">
          ...
          <div style={{ flex: 1, marginLeft: 20 }}>
            <input
              ...
              style={{ outline: "none", backgroundColor: "#eee" }}
              className="border-0 px-3 py-3 w-100 rounded-pill"
            />
          </div>
        </div>
        <hr />
        <div className="d-flex justify-content-between align-items-center">
          <div className="d-flex text-black-50" style={{ cursor: "pointer" }}>
            <Button
              ...
              onChange={(e) => setChangeFile(e.target.files)}
            >
          ...
          <div className="d-flex">
            <Chip
              ...
              className="fw-bold fs-6 bg-info  text-black"
              component="a"
